...
#f 0 
  vett: .FILL 26,1,0 
#ogni elemento del vettore, inizializzato a 0, conta le occorrenze della lettera 
 _main: NOP 
       MOV $0,%EAX 
#dovremo usare EAX come registro puntatore, e solo AL sara' significativo 
punto1: CALL inchar 
#========================== verifica fine stringa ========================== 
        CMP $0xD,%AL 
        JNE lab1 
# salta se stringa non terminata 
        CALL newline 
        JMP punto2 
...
#========================== aggiornamento contatore occorrenze ========================== 
        SUB $'a',%AL 
#in AL va 0 se conteneva la codifica di a; 
