...
.TEXT   _main: NOP
      ...
      punto2: MOV $0, %ESI 
       ...
       ciclo: MOV $0, %EAX 
              ...
              JA niente 
              MOV $1, %DX 
              # e' necessario tornare al punto 1 a fine ciclo 
              SUB $'0', %AL 
...
#========================================================================= # 
# ############################# 
# soluzione due, che tiene conto del consiglio. Tutte le stringhe sono allineati a strlen(" quattro ")=9 
#############################

.DATA    numeri: .ASCII " zero uno due tre quattro cinque sei sette otto nove "
        stringa: .FILL 22, 1 
.TEXT     _main: NOP
         punto1: MOV $22, %CX 
                 LEA stringa, %EBX 
...
# e' necessario tornare al punto 1 a fine ciclo 
                 SUB $'0', %AL 
                 LEA numeri(%EAX,%EAX,8), %EBX 
# mette in EBX l'indirizzo con offset 9 x EAX (9 sono i caratteri della stringa di lunghezza massima) 
                 CALL outmess 
                 JMP next 
         niente: CALL outchar 
           next: INC %ESI 
